...
def get_rse_usage(client, rse_expression):
    ...
    for rse in rse_names:
        ...
        for usage in usage_list:
            ...
            rse_usage[rse]['MinFreeSpace'] = client.get_rse_limits(rse)['MinFreeSpa>    return rse_usage']
...
def get_freespace(rse,rse_usage):
    ...
    target_occupancy = rse_usage[rse]['static']['total'] - rse_usage[rse]['MinFreeSpace']
...
for rse in rse_names:
    freespace = get_freespace(rse,rse_usage)
    try:
